            ...
            <div class="col-lg-12 col-sm-12">
                <div class="order-box">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="ml-auto font-weight-bold"> BDT  {{$total_amount}} </div>
                    </div>
                    <div class="d-flex">
                        <h4> Cost (+)</h4>
                        <?php 
                        ...
                        ?>
                        <div class="ml-auto font-weight-bold"> {{$shipping_amount}} </div>
                    ...
                    <div class="d-flex gr-total">
                        <h5>Grand Total</h5>
                        <div class="ml-auto h5"> BDT {{$grand_total = $total_amount - Session::get('CouponAmount') +$shipping_amount}} </div>
                    </div>
                    <hr> </div> 
            </div>
