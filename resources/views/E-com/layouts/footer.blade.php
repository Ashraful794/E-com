		...
		<div class="footer-bottom-block ">
			<div class=" container">
				<div class="row">
					...
					<div class="col-sm-7">
						<div class="block-payment text-right"><img src="{{asset('front_assets/image/demo/content/payment.png')}}" alt="payment" title="payment" ></div>
					</div>
					<!--Back To Top-->
	...
	<ul class="items">
		<li class="item item-01 facebook"> <a href="{{asset('front_assets/php/facebook.php?account=envato')}}" class="tab-icon"><span class="fa fa-facebook"></span></a>
			<div class="tab-content">
				<div class="title">
					<h5>FACEBOOK</h5>
				</div>
				<div class="loading">
					<img src="{{asset('front_assets/image/theme/lazy-loader.gif')}}" class="ajaxloader" alt="loader">
				</div>
			</div>
		</li>
		<li class="item item-02 twitter"> <a href="{{asset('front_assets/php/twitter.php?account_twitter=envato')}}" class="tab-icon"><span class="fa fa-twitter"></span></a>
			<div class="tab-content">
				<div class="title">
					<h5>TWITTER FEEDS</h5> 
				</div>
		...
		<li class="item item-03 youtube"> <a href="{{asset('front_assets/php/youtubevideo.php?account_video=PY2RLgTmiZY')}}" class="tab-icon"><span class="fa fa-youtube"></span></a>
			<div class="tab-content">
				<div class="title">
					<h5>YouTube</h5>
				</div>
				<div class="loading"> <img src="{{asset('front_assets/image/theme/lazy-loader.gif')}}" class="ajaxloader" alt="loader"></div>
			</div>
		</li>
	</ul>
