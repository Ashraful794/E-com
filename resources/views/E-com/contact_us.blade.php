			...
			<div id="content" class="col-sm-12">
				...
				<div class="info-contact clearfix">
					...
					<div class="col-lg-8 col-sm-8 col-xs-12 contact-form">
						<form action="{{url('/contact_us')}}" method="post" enctype="multipart/form-data" class="form-horizontal">{{csrf_field()}}
							<fieldset>
							...
							<div class="form-group required">
                                ...
                                <div class="form-group required">
								<label class="col-sm-2 control-label" for="input-email">E-Mail Subject</label>
								<div class="col-sm-10">
									<input type="text" name="subject" value="" id="input-email" class="form-control">
									</div>
								</div>
