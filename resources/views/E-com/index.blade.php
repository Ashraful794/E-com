							...
							<div class="module no-margin">
								<div class="yt-content-slider yt-content-slider--arrow1"  data-rtl="yes" data-autoplay="no" data-autoheight="no" data-delay="4" data-speed="0.6" data-margin="0" data-items_column0="1" data-items_column1="1" data-items_column2="1"  data-items_column3="1" data-items_column4="1" data-arrows="yes" data-pagination="no" data-lazyload="yes" data-loop="no" data-hoverpause="yes">
									<div class="yt-content-slide">
										<a href="#"><img src="{{asset('front_assets/image/demo/slider/slider-1.png')}}" alt="slider1" class="img-responsive"></a>
									</div>
									<div class="yt-content-slide">
										<a href="#"><img src="{{asset('front_assets/image/demo/slider/slider-2.png')}}" alt="slider2" class="img-responsive"></a>
									</div>
									<div class="yt-content-slide">
										<a href="#"><img src="{{asset('front_assets/image/demo/slider/slider-3.png')}}" alt="slider3" class="img-responsive"></a>
									</div>
								</div>
								...
								<div class="htmlcontent-block">	
									...
									@foreach($banners as $banner)	
										<li>
											<div class="banners">
												<div>
													<a href="#"><img src="uploads/banners/{{$banner->image}}" alt=""></a>
												</div>
											</div>
										</li>		
										@endforeach	
								...
								<div class="ltabs-items-inner ltabs-slider ">
										...
										<div class="product-item-container">
											<div class="left-block">
												<div class="product-image-container second_img ">
													<img src="{{asset('front_assets/image/demo/shop/resize/J9-270x270.jpg')}}"  alt="Apple Cinema 30&quot;" class="img-responsive" />
													<img src="{{asset('front_assets/image/demo/shop/resize/J5-270x270.jpg')}}"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
												</div>
												<!--Sale Label-->
									...
									<div class="ltabs-item product-layout">
										<div class="product-item-container">
											<div class="left-block">
												<div class="product-image-container second_img ">
													<img src="{{asset('front_assets/image/demo/shop/resize/m1-270x270.jpg')}}"  alt="Apple Cinema 30&quot;" class="img-responsive" />
													<img src="{{asset('front_assets/image/demo/shop/resize/m3-270x270.jpg')}}"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
												</div>
												<!--New Label-->
									...
									<div class="ltabs-item product-layout">
										<div class="product-item-container">
											<div class="left-block">
												<div class="product-image-container second_img ">
													<img src="{{asset('front_assets/image/demo/shop/resize/B10-270x270.jpg')}}"  alt="Apple Cinema 30&quot;" class="img-responsive" />
													<img src="{{asset('front_assets/image/demo/shop/resize/B9-270x270.jpg')}}"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
												</div>
												<!--Sale Label-->
									...
									<div class="ltabs-item product-layout">
										<div class="product-item-container">
											<div class="left-block">
												<div class="product-image-container second_img ">
													<img src="{{asset('front_assets/image/demo/shop/resize/w1-270x270.jpg')}}"  alt="Apple Cinema 30&quot;" class="img-responsive" />
													<img src="{{asset('front_assets/image/demo/shop/resize/w10-270x270.jpg')}}"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
												</div>
									...
									<div class="ltabs-item product-layout">
										<div class="product-item-container">
											<div class="left-block">
												<div class="product-image-container second_img ">
													<img src="{{asset('front_assets/image/demo/shop/resize/B5-270x270.jpg')}}"  alt="Apple Cinema 30&quot;" class="img-responsive" />
													<img src="{{asset('front_assets/image/demo/shop/resize/B10-270x270.jpg')}}"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
												</div>
									...
									<div class="ltabs-item product-layout">
										<div class="product-item-container">
											<div class="left-block">
												<div class="product-image-container second_img ">
													<img src="{{asset('front_assets/image/demo/shop/resize/J5-270x270.jpg')}}"  alt="Apple Cinema 30&quot;" class="img-responsive" />
													<img src="{{asset('front_assets/image/demo/shop/resize/J9-270x270.jpg')}}"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
												</div>
												<!--Sale Label-->
												<span class="label label-sale">-15%</span>
									...
									<div class="ltabs-item product-layout">
										<div class="product-item-container">
											<div class="left-block">
												<div class="product-image-container second_img ">
													<img src="{{asset('front_assets/image/demo/shop/resize/e11-270x270.jpg')}}"  alt="Apple Cinema 30&quot;" class="img-responsive" />
													<img src="{{asset('front_assets/image/demo/shop/resize/E3-270x270.jpg')}}"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
												</div>
												<!--Sale Label-->
												<span class="label label-sale">-15%</span>
												<!--full quick view block-->
						...
						<div class="banner-wraps ">
							<div class="m-banner row">
								<div class="banner htmlconten1 col-lg-4 col-md-4 col-sm-6 col-xs-12">
									<div class="banners">
										<div>
											<a href="#"><img src="{{asset('front_assets/image/demo/cms/banner2-1.png')}}" alt="banner1"></a>
										</div>
									</div>
								</div>
								<div class="htmlconten2 col-lg-4 col-md-4 col-sm-6 col-xs-12">
									<div class="module banners">
											<div>
												<a href="#"><img src="{{asset('front_assets/image/demo/cms/banner2-2.png')}}" alt="banner1"></a>
											</div>
									</div>
										
									<div class="banners">
										<div>
											<a href="#"><img src="{{asset('front_assets/image/demo/cms/banner2-3.png')}}" alt="banner1"></a>
										</div>
									</div>
								...
								<div class="banner htmlconten3 hidden-sm col-lg-4 col-md-4 col-sm-6 col-xs-12">
									<div class="banners">
										<div>
											<a href="#"><img src="{{asset('front_assets/image/demo/cms/banner2-4.png')}}" alt="banner1"></a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="wrap-categories">
						<div class="cat-wrap theme3">
							<div class="content-box">
								<div class="image-cat">
									<a href="#" title="Automotive" target="_blank">
										<img  src="{{asset('front_assets/image/demo/shop/category/automotive-motocrycle.jpg')}}" title="Automotive" alt="Automotive"> 
									</a> 
							...
							<div class="content-box">
								<div class="image-cat">
									<a href="#" title="Automotive" target="_blank">
										<img  src="{{asset('front_assets/image/demo/shop/category/health-beauty.jpg')}}" title="Automotive" alt="Automotive"> 
									</a> 
									<a class="btn-viewmore hidden-xs" href="#" title="View more">View more</a> 		
								</div>	
							...
							<div class="content-box">
								<div class="image-cat">
									<a href="#" title="Automotive" target="_blank">
										<img  src="{{asset('front_assets/image/demo/shop/category/bags-holiday-supplies-gifts.jpg')}}" title="Automotive" alt="Automotive"> 
									</a> 
									<a class="btn-viewmore hidden-xs" href="#" title="View more">View more</a> 		
								</div>	
							...
							<div class="content-box">
								<div class="image-cat">
									<a href="#" title="Automotive" target="_blank">
										<img  src="{{asset('front_assets/image/demo/shop/category/toys-hobbies.jpg')}}" title="Automotive" alt="Automotive"> 
									</a> 
									<a class="btn-viewmore hidden-xs" href="#" title="View more">View more</a> 		
								</div>	
							...
							<div class="content-box">
								<div class="image-cat">
									<a href="#" title="Automotive" target="_blank">
										<img  src="{{asset('front_assets/image/demo/shop/category/electronics.jpg')}}" title="Automotive" alt="Automotive"> 
									</a> 
									<a class="btn-viewmore hidden-xs" href="#" title="View more">View more</a> 		
								</div>	
							...
							<div class="content-box">
								<div class="image-cat">
									<a href="#" title="Automotive" target="_blank">
										<img  src="{{asset('front_assets/image/demo/shop/category/jewelry-watches.jpg')}}" title="Automotive" alt="Automotive"> 
									</a> 
									<a class="btn-viewmore hidden-xs" href="#" title="View more">View more</a> 		
								</div>	
							...
							<div class="content-box">
								<div class="image-cat">
									<a href="#" title="Automotive" target="_blank">
										<img  src="{{asset('front_assets/image/demo/shop/category/sports-outdoors.jpg')}}" title="Automotive" alt="Automotive"> 
									</a> 
									<a class="btn-viewmore hidden-xs" href="#" title="View more">View more</a> 		
								</div>	
							...
							<div class="content-box">
								<div class="image-cat">
									<a href="#" title="Automotive" target="_blank">
										<img  src="{{asset('front_assets/image/demo/shop/category/smartphone-tablets.jpg')}}" title="Automotive" alt="Automotive"> 
									</a> 
									<a class="btn-viewmore hidden-xs" href="#" title="View more">View more</a> 		
								</div>	
